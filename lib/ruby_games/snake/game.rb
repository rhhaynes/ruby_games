class RubyGames::Snake::Game
    ...
    def create_food(n)
        ...
        @food = RubyGames::Snake::Food.create(n, props, invalid)
    end
    ...
    def create_obstacles(n)
        ...
        @obstacles = RubyGames::Snake::Obstacle.create(n, props, invalid)
    end
    ...
    def reset
        ...
        @tick = 0
        @paused = true
        @snake = RubyGames::Snake::Snake.new(@max_y/2, 25)
        create_obstacles(20)
        create_food(8)
    end
end
